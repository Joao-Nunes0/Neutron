...
<div class="row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <div class="col-md-4 mb-3">
        <div class="input-group mb-3">
          <span class="input-group-text">Engenheiros</span>
          <select class="form-select" name="workers"  id="id_wkr" aria-describedby="basic-addon1">
        ...
        <?php
            ...
            ?>
                <option value="<?php echo $row2['id_wkr'];?>"><?php echo $row2['id_wkr'];?> - <?php echo $row2['name_wkr'];?></option>
            <?php
                  }
                }
            ?>
  ...
  <center>
    <button type="button" id="updatebuttonValue" class="btn btn-outline-success">Designar</button>
  </center>
  <br/ >
